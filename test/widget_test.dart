...
void main() {
  testWidgets('Memastikan Aplikasi Katalog Beranda Tampil', (WidgetTester tester) async {
    ...
    expect(find.text('Katalog Sepatu'), findsOneWidget);
  ...
  testWidgets('Navigasi dari Beranda ke Detail Katalog', (WidgetTester tester) async {
    ...
    await tester.tap(find.text('Katalog Sepatu'));
    await tester.pumpAndSettle(); 
    
    expect(find.text('Detail Katalog'), findsOneWidget);
    expect(find.text('Sepatu sneakers kasual yang nyaman digunakan untuk aktivitas sehari-hari maupun bepergian. Desain modern dan tahan lama.'), findsOneWidget);
  });
}